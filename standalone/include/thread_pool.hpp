...
#ifndef BINARY_ALL_STANDALONE_INCLUDE_THREAD_POOL_HPP_
#define BINARY_ALL_STANDALONE_INCLUDE_THREAD_POOL_HPP_
...
namespace dp {
  ...
  class thread_pool {
  public:
    explicit thread_pool(const unsigned int &number_of_threads
...
#endif  // BINARY_ALL_STANDALONE_INCLUDE_THREAD_POOL_HPP_
